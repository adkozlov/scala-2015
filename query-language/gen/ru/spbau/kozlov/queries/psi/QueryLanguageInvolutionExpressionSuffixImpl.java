...
public class QueryLanguageInvolutionExpressionSuffixImpl extends QueryLanguageElementImpl implements QueryLanguageInvolutionExpressionSuffix {

  public QueryLanguageInvolutionExpressionSuffixImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof QueryLanguageVisitor) ((QueryLanguageVisitor)visitor).visitInvolutionExpressionSuffix(this);
