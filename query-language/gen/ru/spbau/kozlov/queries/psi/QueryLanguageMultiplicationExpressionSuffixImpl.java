...
public class QueryLanguageMultiplicationExpressionSuffixImpl extends QueryLanguageElementImpl implements QueryLanguageMultiplicationExpressionSuffix {

  public QueryLanguageMultiplicationExpressionSuffixImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof QueryLanguageVisitor) ((QueryLanguageVisitor)visitor).visitMultiplicationExpressionSuffix(this);
